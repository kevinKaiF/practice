...
public class MyTreeMap<K,V>
    ...
    private transient MyTreeMap.Entry<K,V> root = null;
    ...
    /**
     * Returns a shallow copy of this {@code MyTreeMap} instance. (The keys and
     ...
     */
    private transient MyTreeMap.EntrySet entrySet = null;
    private transient MyTreeMap.KeySet<K> navigableKeySet = null;
    ...
    public NavigableSet<K> navigableKeySet() {
        MyTreeMap.KeySet<K> nks = navigableKeySet;
...
//        return (vs != null) ? vs : (values = new MyTreeMap.Values());
        return null;
    }
    ...
    static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E> {
        ...
        public Iterator<E> iterator() {
            if (m instanceof MyTreeMap)
                return ((MyTreeMap<E,Object>)m).keyIterator();
            else
                return (Iterator<E>)(((MyTreeMap.NavigableSubMap)m).keyIterator());
        }

        public Iterator<E> descendingIterator() {
            if (m instanceof MyTreeMap)
                return ((MyTreeMap<E,Object>)m).descendingKeyIterator();
            else
                return (Iterator<E>)(((MyTreeMap.NavigableSubMap)m).descendingKeyIterator());
        }
    ...
    /**
     * Base class for MyTreeMap Iterators
     */
    ...
    abstract static class NavigableSubMap<K,V> extends AbstractMap<K,V>
        ...
        transient MyTreeMap.NavigableSubMap.EntrySetView entrySetView = null;
        transient MyTreeMap.KeySet<K> navigableKeySetView = null;
     ...
     * @serial include
     */
    static final class AscendingSubMap<K,V> extends MyTreeMap.NavigableSubMap<K,V> {
        ...
        public NavigableMap<K,V> subMap(K fromKey, boolean fromInclusive,
            ...
            return new MyTreeMap.AscendingSubMap(m,
                    false, fromKey, fromInclusive,
                    false, toKey,   toInclusive);
        }
        ...
        public NavigableMap<K,V> descendingMap() {
            ...
            return (mv != null) ? mv :
                    (descendingMapView =
                            new MyTreeMap.DescendingSubMap(m,
                                    fromStart, lo, loInclusive,
                                    toEnd,     hi, hiInclusive));
        }
        ...
        public Set<Map.Entry<K,V>> entrySet() {
            ...
            return (es != null) ? es : new MyTreeMap.AscendingSubMap.AscendingEntrySetView();
        }
    ...
    static final class DescendingSubMap<K,V>  extends MyTreeMap.NavigableSubMap<K,V> {
        ...
        public Set<Map.Entry<K,V>> entrySet() {
            EntrySetView es = entrySetView;
            return (es != null) ? es : new MyTreeMap.DescendingSubMap.DescendingEntrySetView();
        }
     ...
     * compatibility with previous releases of MyTreeMap that did not
    ...
    static final class Entry<K,V> implements Map.Entry<K,V> {
        ...
        MyTreeMap.Entry<K,V> right = null;
        MyTreeMap.Entry<K,V> parent;
        boolean color = BLACK;
    ...
    /**
     * Save the state of the {@code MyTreeMap} instance to a stream (i.e.,
     * serialize it).
     *
     * @serialData The <em>size</em> of the MyTreeMap (the number of key-value
     *             mappings) is emitted (int), followed by the key (Object)
     *             and value (Object) for each key-value mapping represented
     *             by the MyTreeMap. The key-value mappings are emitted in
     *             key-order (as determined by the MyTreeMap's Comparator,
    ...
    /**
     * Reconstitute the {@code MyTreeMap} instance from a stream (i.e.,
     * deserialize it).
     */
     ...
     *
     * It is assumed that the comparator of the MyTreeMap is already set prior
     ...
     * It is assumed that the comparator and size fields of the MyTreeMap are
