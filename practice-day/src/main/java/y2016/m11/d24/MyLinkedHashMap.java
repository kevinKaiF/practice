...
public class MyLinkedHashMap <K,V>
     ...
     */
    public transient MyLinkedHashMap.Entry<K,V> header;
    ...
    @Override
    void init() {
        header = new MyLinkedHashMap.Entry<>(-1, null, null, null);
    ...
    public boolean containsValue(Object value) {
        ...
        if (value==null) {
            for (MyLinkedHashMap.Entry e = header.after; e != header; e = e.after)
                if (e.value==null)
                    return true;
        } else {
            for (MyLinkedHashMap.Entry e = header.after; e != header; e = e.after)
    ...
    public V get(Object key) {
        MyLinkedHashMap.Entry<K,V> e = (MyLinkedHashMap.Entry<K,V>)getEntry(key);
        if (e == null)
            return null;
        e.recordAccess(this);
        return e.value;
    ...
    public static class Entry<K,V> extends MyHashMap.Entry<K,V> {
        ...
        public MyLinkedHashMap.Entry<K,V> before, after;
         ...
         */
        private void addBefore(MyLinkedHashMap.Entry<K,V> existingEntry) {
            after  = existingEntry;
         ...
         */
        void recordAccess(MyLinkedHashMap<K,V> m) {
    ...
    private abstract class LinkedHashIterator<T> implements Iterator<T> {
        MyLinkedHashMap.Entry<K,V> nextEntry    = header.after;
        MyLinkedHashMap.Entry<K,V> lastReturned = null;
